...
public class BaseExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        if(v == null){
            viewHolder = new ViewHolder();
            v = inflater.inflate(R.layout.student_list_expendable, null);
            viewHolder.tv_childName = (TextView) v.findViewById(R.id.child);
            v.setTag(viewHolder);
    ...
    class ViewHolder {
        //recyclerview.adapter 로 안드로이드 스튜디오내장 객체가 나옴
